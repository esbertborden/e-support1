...
//     setBankMenuOpen(false) // Close bank menu when collapsing
//   }
...
//         className="md:hidden fixed top-4 left-4 z-50 p-2 rounded-md bg-blue-500 text-white"
//       >
...
export default function DashboardPage() {
  ...
  return ( 
    <div className="flex min-h-screen">
      ...
      {/* Right side content area with Header */}
      <div className={`
